...
[WebServiceBinding(Name="ShipmentService-Public_4_3_SOAP", Namespace="http://dpd.com/common/service/ShipmentService/4.3")]
[XmlRoot("ShipmentServicePublic_4_3")]
public partial class ShipmentServicePublic_4_3 : SoapHttpClientProtocol {
    ...
    /// <remarks/>
    public ShipmentServicePublic_4_3() {
        this.Url = "https://public-ws-stage.dpd.com/services/ShipmentService/V4_3/";
    }
    ...
    /// 
    /// Sample request:
    /// &lt;soapenv:Envelope xmlns:soapenv=&quot;http://schemas.xmlsoap.org/soap/envelope/&quot; xmlns:ns=&quot;http://dpd.com/common/service/types/Authentication/2.0&quot; xmlns:ns1=&quot;http://dpd.com/common/service/types/ShipmentService/4.3&quot;&gt;
    ///    &lt;soapenv:Header&gt;
    ///       &lt;ns:authentication&gt;
    ...
    [SoapDocumentMethod("http://dpd.com/common/service/ShipmentService/4.3/storeOrders", Use=SoapBindingUse.Literal, ParameterStyle=SoapParameterStyle.Bare, RequestElementName = "storeOrders", ResponseElementName = "storeOrdersResponse")]
    [return: XmlElement("storeOrdersResponse", Namespace="http://dpd.com/common/service/types/ShipmentService/4.3")]
    public StoreOrdersResponse StoreOrders([XmlElement("storeOrders", Namespace="http://dpd.com/common/service/types/ShipmentService/4.3")] StoreOrders storeOrders1) {
...
[DebuggerStepThrough]
[DesignerCategory("code")]
[XmlType(Namespace="http://dpd.com/common/service/types/ShipmentService/4.3")]
...
public partial class Delivery {
    ...
    /// <remarks/>
    [XmlIgnore]
    public bool TimeFromSpecified => this.TimeFrom.HasValue;
    ...
    /// <remarks/>
    [XmlIgnore]
    public bool TimeToSpecified => this.TimeTo.HasValue;
}
...
public partial class Pickup {
    ...
    /// <summary> Pickup day of week for consignments and pickup information. Allowed values are 0..6 (0=Sunday, 1=Monday, etc.). Mandatory for consignment. </summary>
    [XmlElement("day", Form=XmlSchemaForm.Unqualified)]
    ...
    /// <remarks/>
    [XmlIgnore]
    public bool FromTime1Specified => this.FromTime1.HasValue;
    ...
    public int? ToTime1 { get; set; }
    
    /// <remarks/>
    [XmlIgnore]
    public bool ToTime1Specified => this.ToTime1.HasValue;
    ...
    public int? FromTime2 { get; set; }
    
    /// <remarks/>
    [XmlIgnore]
    public bool FromTime2Specified => this.FromTime2.HasValue;
    ...
    public int? ToTime2 { get; set; }
    
    /// <remarks/>
    [XmlIgnore]
    public bool ToTime2Specified => this.ToTime2.HasValue;
...
[GeneratedCode("wsdl", "4.8.3928.0")]
[Serializable]
[XmlType(AnonymousType=true, Namespace="http://dpd.com/common/service/types/ShipmentService/4.3")]
...
public partial class International {
    ...
    /// <summary> Parcel value (in invoice currency) with two decimal digits without separator. </summary>
    [XmlElement("customsAmountParcel", Form=XmlSchemaForm.Unqualified)]
    public long? CustomsAmountParcel { get; set; }
    
    /// <remarks/>
    [XmlIgnore]
    public bool CustomsAmountParcelSpecified => this.CustomsAmountParcel.HasValue;
    ...
    /// <summary> Declares the content of the parcel. </summary>
    [XmlElement("customsContent", Form=XmlSchemaForm.Unqualified)]
    public string CustomsContent { get; set; }
    
    /// <summary> Declares the customs tarif number. </summary>
    [XmlElement("customsTarif", Form=XmlSchemaForm.Unqualified)]
    public string CustomsTarif { get; set; }
    ...
    public Address CommercialInvoiceConsignee { get; set; }
...
/// <summary> Bundles cash on delivery data. </summary>
[GeneratedCode("wsdl", "4.8.3928.0")]
[Serializable]
[DebuggerStepThrough]
[DesignerCategory("code")]
...
public partial class Cod {
    ...
    /// <summary> ISO 4217 alpha-3 currency code (destination country). </summary>
    ...
    /// 1 = Crossed cheque.
    /// </summary>
    [XmlElement("inkasso", Form=XmlSchemaForm.Unqualified)]
    public int Inkasso { get; set; }
    
    /// <summary> Purpose of use. </summary>
    [XmlElement("purpose", Form=XmlSchemaForm.Unqualified)]
    public string Purpose { get; set; }
    
    /// <summary> Bank code. If this value is filled, parameters for bankName, bankAccountNumber and bankAccountHolder must also be filled. </summary>
    [XmlElement("bankCode", Form=XmlSchemaForm.Unqualified)]
    public string BankCode { get; set; }
    
    /// <summary> Bank name. If this value is filled, parameters for bankCode, bankAccountNumber and bankAccountHolder must also be filled. </summary>
    [XmlElement("bankName", Form=XmlSchemaForm.Unqualified)]
    public string BankName { get; set; }
    
    /// <summary> Bank account number. If this value is filled, parameters for bankCode, bankName and bankAccountHolder must also be filled. </summary>
    [XmlElement("bankAccountNumber", Form=XmlSchemaForm.Unqualified)]
    public string BankAccountNumber { get; set; }
    
    /// <summary> Account holder. If this value is filled, parameters for bankCode, bankName and bankAccountNumber must also be filled. </summary>
    [XmlElement("bankAccountHolder", Form=XmlSchemaForm.Unqualified)]
...
public partial class Parcel {
    ...
    /// <summary> Contains COD data for COD consignments. </summary>
    [XmlElement("cod", Form=XmlSchemaForm.Unqualified)]
